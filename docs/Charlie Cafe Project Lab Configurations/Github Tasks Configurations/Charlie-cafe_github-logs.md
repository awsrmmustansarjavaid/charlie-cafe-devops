...
### Fully Final GitHub CLI

- Installs GitHub CLI on Amazon Linux 2023.

- Checks authentication with GitHub.

- Lists workflows and workflow runs.

- Captures logs for all workflow runs into timestamped files.

- Gives instructions for optional live streaming.

#### ✅ Here’s the final combined Bash script:
...
#### Optional: Watch workflow logs live:

```
gh run watch 173
```

This script fully automates the setup, authentication, and log capture process on EC2.
